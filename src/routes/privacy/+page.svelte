		...
		<section class="grid gap-10 sm:gap-12">
			<div class="group">
				...
				<p class="font-body text-base leading-relaxed text-ink/70 sm:text-lg">
					BLEP processes device/listing text you submit and optional URLs you provide so it can
					generate a hardware purchase verdict.
				</p>
			</div>
			...
			<div class="group">
				...
				<p class="font-body text-base leading-relaxed text-ink/70 sm:text-lg">
					BLEP may send your query, source page content, and related source metadata
					to external service providers to generate hardware verdicts.
				</p>
			</div>
			...
			<div class="group">
				...
				<p class="font-body text-base leading-relaxed text-ink/70 sm:text-lg">
					BLEP may cache verdicts and source summaries for cost control, speed, and stability.
					Cache entries can include verdict JSON, source titles, source URLs, timestamps, and hashes
			...
			<div class="group">
				...
				<div class="mt-4 flex flex-col gap-3">
					<a
						...
						class="focus-visible-ring inline-flex items-center gap-2.5 text-ink/70 hover:text-ink transition-colors w-fit"
					>
						...
						<span class="font-body text-base leading-relaxed sm:text-lg">github.com/justhenix</span>
					</a>
					<a
						...
						class="focus-visible-ring inline-flex items-center gap-2.5 text-ink/70 hover:text-ink transition-colors w-fit"
					>
						<svg class="h-4.5 w-4.5 fill-current" viewBox="0 0 24 24" aria-hidden="true">
							<path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
						</svg>
						<span class="font-body text-base leading-relaxed sm:text-lg">x.com/heni0x</span>
					</a>
				</div>
			</div>
		</section>
